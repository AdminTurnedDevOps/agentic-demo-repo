module github.com/adminturneddevops/agentic-demo-repo/substrate/kagent-substrate/kagent-oss-hermes
...
require (
	...
	github.com/kagent-dev/kagent/go v0.0.0-20260914121127-0fbf966bab23
