1. Download the `arctl`
```
curl -fsSL https://raw.githubusercontent.com/agentregistry-dev/agentregistry/main/scripts/get-arctl | bash
```

2. Make sure its working
```
arctl
```

3. Create a directory for your new skill
```
mkdir gke-expert
```
...
4. Create the skill
```
arctl skill init gke-expert
```

5. Open up the SKILLS.md file and copy/paste in the following skill.
...
6. Because you don't need to put anything into the references, assets, or scripts files/directories, you can delete those directories.

7. Publish the container image skill. you'll need to update the below command to your GitHub org.
```
arctl skill publish . --docker-url docker.io/adminturneddevops --push
```

8. You can test to confirm this worked by pulling the Skill locally.

```
arctl skill pull gke-expert
```

9. Open the registry by opening Dockerhub and clicking on the server running

10. Add a skill by clicking the purpose **Add** button

11. Add your Skill in with a name, description, version, and the path to the container image hosting the Skill.

12. You should now be able to see your Skill in the agentregistry UI.